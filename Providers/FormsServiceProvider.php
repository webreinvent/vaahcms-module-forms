...
class FormsServiceProvider extends ServiceProvider
{
    ...
    private function registerMiddleware($router) {
        ...
        //register middleware
        //$router->aliasMiddleware('sample.middleware', \Forms\Http\Middleware\SampleMiddleware::class);
    ...
    {
        $viewPath = resource_path('/views/vaahcms/modules/forms');
    ...
    public function registerAssets()
    {
        ...
        $desPath = public_path('vaahcms/modules/forms/assets');
    ...
    {
        $langPath = resource_path('/lang/vaahcms/modules/forms');
